        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    art_Tipo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SectoresIdSector = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Articulo", x => x.art_CodGen);
                    table.ForeignKey(
                        name: "FK_Articulo_Sectores_SectoresIdSector",
                        column: x => x.SectoresIdSector,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Sectores_SectoresIdSector",
                        column: x => x.SectoresIdSector,
                        principalTable: "Sectores",
                        principalColumn: "IdSector");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupervisorNavigationId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Programacions_Estados_EstadoId",
                        column: x => x.EstadoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResposableNavigationId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Produccions", x => x.IdProduccion);
                    table.ForeignKey(
                        name: "FK_Produccions_AspNetUsers_ResposableNavigationId",
                        column: x => x.ResposableNavigationId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articulo_SectoresIdSector",
                table: "Articulo",
                column: "SectoresIdSector");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_SectoresIdSector",
                table: "AspNetUsers",
                column: "SectoresIdSector");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Produccions",
                column: "ResposableNavigationId");

            migrationBuilder.CreateIndex(
                name: "IX_Programacions_EstadoId",
                table: "Programacions",
                column: "EstadoId");
