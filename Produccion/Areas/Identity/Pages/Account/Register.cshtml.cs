...
namespace Producciones.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private Usuarios CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"No se puede crear una instancia de '{nameof(Usuarios)}'. " +
                    $"Asegúrese de que '{nameof(Usuarios)}' no es una clase abstracta y tiene un constructor sin parámetros, o alternativamente  " +
        ...
        private IUserEmailStore<Usuarios> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("La interfaz de usuario por defecto requiere un almacén de usuario con soporte de correo electrónico.");
            }
