...
namespace Producciones.Areas.Identity.Pages.Account.Manage
{
    public class GenerateRecoveryCodesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                throw new InvalidOperationException($"No se pueden generar códigos de recuperación para el usuario porque no tiene 2FA activado.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!isTwoFactorEnabled)
            {
                throw new InvalidOperationException($"No se pueden generar códigos de recuperación para el usuario ya que no tiene 2FA activado.");
            }
